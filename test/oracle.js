...
var contract = require("truffle-contract");
 ...
 //var OracleRequests = artifacts.require("./contracts/OracleRequests.sol");
    //var  OR =OracleRequests.deployed().then(function(instance){
    var  OR =OracleRequests.at("0x7dd2a41f0d45f984ed70308b41e837551eee7f6b").then(function(instance){
